...
bool load_images()
{
    ...
    if (!Player::get_texture().load_from_file("assets/images/player_animations2.png"))
    {
        success = false;
        printf("Failed to load player animations sprite\n");
    }
    
    if (!Kunai::get_texture().load_from_file("assets/images/kunai.png"))
    {
        success = false;
        printf("Failed to load kunai image\n");
    }
    
    if (!Hearts::get_texture().load_from_file("assets/images/pixel_hearts.png"))
    {
        success = false;
        printf("Failed to load heart sprite\n");
    }
    if (!Apple::get_texture().load_from_file("assets/images/apple.png"))
    {
        success = false;
        printf("Failed to load apple image\n");
    }
    if (!Shield::get_texture().load_from_file("assets/images/shield.png"))
    {
        success = false;
        printf("Failed to load shield image\n");
    }
    if (!MenuButton::get_texture().load_from_file("assets/images/home_icon.png"))
    {
        success = false;
        printf("Failed to load home icon image\n");
    }
    
    if (!MusicButton::get_texture_on().load_from_file("assets/images/sound_on_icon.png"))
    {
        success = false;
        printf("Failed to load sound on image\n");
    }
    
    if (!MusicButton::get_texture_off().load_from_file("assets/images/sound_off_icon.png"))
    {
        success = false;
        printf("Failed to load sound off image\n");
    }
    
    if (!ControlsButton::get_texture().load_from_file("assets/images/controls_button.png"))
    {
        success = false;
        printf("Failed to load controls button image\n");
    }
    if (!g_controls_manual.load_from_file("assets/images/game_manual.png"))
    {
        success = false;
        printf("Failed to load controls menu \n");
    }
    if (!g_menu.load_from_file("assets/images/menu_in_progress.png"))
    {
        success = false;
        printf("Failed to load controls menu \n");
    }
...
bool load_fonts()
{
    ...
    gp_arial_font = load_font_from_file("assets/fonts/arial.ttf", 13);
    ...
    gp_crayon_font = load_font_from_file("assets/fonts/pastel_crayon.ttf", 17);
...
bool load_audio()
{
    ...
    gp_background_music = Mix_LoadMUS("assets/audio/background_music.mp3");
    ...
    gp_kunai_throw_sound = Mix_LoadWAV("assets/audio/kunai_throw.wav");
    ...
    gp_kunai_hit_sound = Mix_LoadWAV("assets/audio/kunai_hit.wav");
    ...
    gp_click_sound = Mix_LoadWAV("assets/audio/click.wav");
    ...
    gp_shield_hit_sound = Mix_LoadWAV("assets/audio/shield_hit.wav");
    ...
    gp_apple_hit_sound = Mix_LoadWAV("assets/audio/apple_hit.wav");
